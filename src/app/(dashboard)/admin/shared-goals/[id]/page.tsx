...
export default async function AdminSharedGoalDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-4">
        <Link href="/admin/shared-goals" className="text-sm text-muted-foreground hover:text-foreground flex items-center gap-1 w-fit">
